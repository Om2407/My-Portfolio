        ...
        <div className="max-w-5xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="p-6 rounded-xl border border-white/10 hover:-translate-y-1 hover:border-blue-500/30 hover:shadow-[0_2px_8px_rgba(59,130,246,0.2)] transition">
              ...
              <p className="text-gray-400 mb-4">Developed JavaScript-based browser extension to automatically detect and remove YouTube advertisements and promotional content, improving user viewing experience for 10,000+ monthly users
            ...
            >
              ...
              <p className="text-gray-400 mb-4">Developed voice recognition algorithms using Backend/frntend to process spoken commands with 95% accuracy across multiple languages
